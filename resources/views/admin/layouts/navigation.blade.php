<nav x-data="{ open: false }" class="bg-dark  border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class=" hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 text-white-800 ">
            <div class="px-4">
                <div class="font-medium text-base text-white-800">{{ Auth::guard('admin')->user()->name }}</div>
                <div class="font-medium text-sm text-white-500">{{ Auth::guard('admin')->user()->email }}</div>
            </div>
